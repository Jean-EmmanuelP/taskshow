 ...
 * 
 * Checks if user is authenticated and redirects to appropriate dashboard
 * If not authenticated, shows the landing page with login/register options
 */
        ...
        <Router>
          <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow">
              <Routes>
                {/* Public Routes - Landing page with auth check */}
                <Route 
                  path="/" 
                  element={
                    <AuthWrapper>
